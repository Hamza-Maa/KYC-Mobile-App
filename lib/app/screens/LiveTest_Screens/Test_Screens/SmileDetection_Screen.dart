...
import 'package:kyc_mobile_app/app/screens/LiveTest_Screens/Test_Screens/GlassesDetection_Screen.dart';
...
class SmileDetectionScreen extends ConsumerWidget {
  const SmileDetectionScreen({super.key});
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              CustomNotification(
                text: "Smile detected.Next: Blink detection.",
