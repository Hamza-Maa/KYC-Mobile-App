...
import 'package:kyc_mobile_app/app/screens/ID_capture_screens/IDCardSecondCaptureScreen.dart';
...
class IDCardFirstCaptureScreen extends ConsumerStatefulWidget {
  const IDCardFirstCaptureScreen({super.key});

  @override
  _PassportCaptureScreenState createState() => _PassportCaptureScreenState();
}

class _PassportCaptureScreenState extends ConsumerState<IDCardFirstCaptureScreen> {
  ...
  Future<void> _uploadAndNavigate(BuildContext context, XFile photo) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => IDCardSecondCaptureScreen(
            photo: photo,
          ),
        ),
      );
